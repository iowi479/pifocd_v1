...
public:
    ...
    bool canPushPacket(Packet *packet, const cGate *gate) const override { return getNumPackets() < getMaxNumPackets(); };
    ...
    bool canPullSomePacket(const cGate *gate) const override { return !isEmpty(); }
